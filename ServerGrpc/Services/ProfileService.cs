...
public class ProfileService : Perfil.PerfilBase
{
    ...
    static async Task<ServerGrpc.Clases.User> LoginAsync(NetworkHelper networkHelper, Header encabezado, NetworkStream networkStream, IModel chanel)
    {
        ...
        ServerGrpc.Clases.User loggedUser = _singleton.LoginBack(loginData[0], loginData[1]);
    ...
    static async Task<ServerGrpc.Clases.User> RegisterAsync(NetworkHelper networkHelper, Header encabezado, NetworkStream networkStream, IModel chanel)
    {
        // recibe un mensaje
        ...
        ServerGrpc.Clases.User newUser = null;

        if (_singleton.ValidateData(registerData[1]))
        {
            newUser = new ServerGrpc.Clases.User(registerData[0], registerData[1], registerData[2]);
    ...
    static async Task CrearPerfilLaboralAsync(NetworkHelper networkHelper, Header encabezado, ServerGrpc.Clases.User user, NetworkStream networkStream, IModel chanel)
    {
        if (user == null)
        {
    ...
    static async Task SubirFotoAsync(NetworkHelper networkHelper, Header encabezado, ServerGrpc.Clases.User user, NetworkStream networkStream, IModel chanel)
    {
    ...
    static async Task LeerChatAsync(NetworkHelper networkHelper, Header encabezado, ServerGrpc.Clases.User loggedUser, NetworkStream networkStream, IModel chanel)
    {
    ...
    static async Task EnviarChatAsync(NetworkHelper networkHelper, Header encabezado, ServerGrpc.Clases.User loggedUser, NetworkStream networkStream, IModel chanel)
    {
    ...
    static async Task HandleClient(TcpClient tcpClientSocket, IModel channel)
    {
        ...
        bool conectado = true;
        ServerGrpc.Clases.User user = null;
